...
#include "Chess/MyGameModeBase.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	CHESS_API UClass* Z_Construct_UClass_AMyGameModeBase_NoRegister();
	CHESS_API UClass* Z_Construct_UClass_AMyGameModeBase();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMyGameModeBase_Statics::NewProp_Board_MetaData[] = {
		{ "ModuleRelativePath", "MyGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMyGameModeBase_Statics::NewProp_Board = { "Board", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMyGameModeBase, Board), Z_Construct_UClass_ABoard_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AMyGameModeBase_Statics::NewProp_Board_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMyGameModeBase_Statics::NewProp_Board_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMyGameModeBase_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyGameModeBase_Statics::NewProp_Board,
	};
	...
	IMPLEMENT_CLASS(AMyGameModeBase, 1009287514);
	template<> CHESS_API UClass* StaticClass<AMyGameModeBase>()
	{
		return AMyGameModeBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyGameModeBase(Z_Construct_UClass_AMyGameModeBase, &AMyGameModeBase::StaticClass, TEXT("/Script/Chess"), TEXT("AMyGameModeBase"), false, nullptr, nullptr, nullptr);
